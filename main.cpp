...
#include "Products.hpp"     // Classes for products
#include "Person.hpp"       // User part 
#include "loadingPage.hpp" // Loading Animation
#include "validation.hpp"   // Validation for User inputted information
#include "passwordValiAsterisk.hpp"   // Password "********"

using namespace std;

// Objects
Validation_C User_Validtaion;
User User_1(memoryName, memoryPhone, memoryLogin, memoryParol);
	...
	for (int i = 0; i < 1000; i++) {
		...
		case 50: {  // Register
			...
			for (int i = 0; i != 1;) {
				...
				validationPhoneNumber(User_Validtaion);
				...
				if (validation == 3) {
					...
					User_Info << memoryName << endl;
					User_Info << memoryPhone << endl;
					User_Info << memoryLogin << endl;
					User_Info << memoryParol << endl;
					User_Info.close();
	...
	for (int i = 0; i < 1000; i++) {
		...
		case 50: {  // Sign in as User
			...
			while (Search) {
				...
				Search >> memoryLogin;
				Search >> memoryParol;
				if (login_sign == memoryLogin && parol_sign == memoryParol) {
					User User_1(memoryName, memoryPhone, memoryLogin, memoryParol);
					F_User_Main_Menu();
				}
			}
...
void F_User_Main_Menu() {
	...
	for (int i = 0; i < 1000; i++) {
		...
		case 56: { // User info   
			...
			cout << "\t\t\t\t      User Name : " << memoryName << endl;
			cout << "\t\t\t\t      Telephone : " << memoryPhone << endl;
			cout << "\t\t\t\t      Login     : " << memoryLogin << endl;
			cout << "\t\t\t\t      Password  : " << memoryParol << endl << endl << endl;
			system("pause");
		}
			   break;
			...
			for (int j = 0; j < 1000; j++) {
				...
				case 49:
					if (Product1_1.getQuantity() > 0) { // checking for storage and user needs
						User_1._product1User1++;
						Product1_1.quantity--;
						cout << " Quantity of "<< Product1_1.getName() << " - " << User_1._product1User1 << endl;
					...
					break;
				case 50:
					if (User_1._product1User1 > 0) { // Check for (-1 kg/pc)
						User_1._product1User1--;
						Product1_1.quantity++;
						cout << " Quantity of " << Product1_1.getName() << " - "  << User_1._product1User1 << endl;
			...
			for (int j = 0; j < 1000; j++) {
				...
				case 49:
					if (Product1_2.getQuantity() > 0) { // checking for storage and user needs
						User_1._product1User2++;
						Product1_2.quantity--;
						cout << " Quantity of " << Product1_2.getName() << " - " << User_1._product1User2 << endl;
						cout << "    Successfully added \n";
						Sleep(0700); Sleep(0700);
					}
					else {
					...
					break;
				case 50:
					if (User_1._product1User2 > 0) { // Check for (-1 kg/pc)
						User_1._product1User2--;
						Product1_2.quantity++;
						cout << " Quantity of " << Product1_2.getName() << " - " << User_1._product1User2 << endl;
						cout << "    Successfully decreased \n";
			...
			for (int j = 0; j < 1000; j++) {
				...
				case 49:
					if (Product1_3.getQuantity() > 0) { // checking for storage and user needs
						User_1._product1User3++;
						Product1_3.quantity--;
						cout << " Quantity of " << Product1_3.getName() << " - " << User_1._product1User3 << endl;
						cout << "    Successfully added \n";
						Sleep(0700); Sleep(0700);
					}
					else {
					...
					break;
				case 50:
					if (User_1._product1User3 > 0) { // Check for (-1 kg/pc)
						User_1._product1User3--;
						Product1_3.quantity++;
						cout << " Quantity of " << Product1_3.getName() << " - " << User_1._product1User3 << endl;
						cout << "    Successfully decreased \n";
			...
			for (int j = 0; j < 1000; j++) {
				...
				case 49:
					if (Product2_1.getQuantity() > 0) { // checking for storage and user needs
						Product2_1.quantity--;
						User_1._product2User1++;
						cout << " Quantity of " << Product2_1.getName() << " - " << User_1._product2User1 << endl;
						cout << "    Successfully added \n";
						Sleep(0700); Sleep(0700);
					}
					else {
					...
					break;
				case 50:
					if (User_1._product2User1 > 0) { // Check for (-1 kg/pc)
						Product2_1.quantity++;
						User_1._product2User1--;
						cout << " Quantity of " << Product2_1.getName() << " - "  << User_1._product2User1 << endl;
						cout << "    Successfully decreased \n";
			...
			for (int j = 0; j < 1000; j++) {
				...
				case 49:
					if (Product2_2.getQuantity() > 0) { // checking for storage and user needs
						Product2_2.quantity--;
						User_1._product2User2++;
						cout << " Quantity of " << Product2_2.getName() << " - " << User_1._product2User2 << endl;
						cout << "    Successfully added \n";
						Sleep(0700); Sleep(0700);
					}
					else {
					...
					break;
				case 50:
					if (User_1._product2User2 > 0) { // Check for (-1 kg/pc)
						Product2_2.quantity++;
						User_1._product2User2--;
						cout << " Quantity of " << Product2_2.getName() << " - " << User_1._product2User2 << endl;
						cout << "    Successfully decreased \n";
			...
			for (int j = 0; j < 1000; j++) {
				...
				case 49:
					if (Product2_3.getQuantity() > 0) { // checking for storage and user needs
						Product2_3.quantity--;
						User_1._product2User3++;
						cout << " Quantity of " << Product2_3.getName() << " - " << User_1._product2User3 << endl;
						cout << "    Successfully added \n";
						Sleep(0700); Sleep(0700);
					}
					else {
					...
					break;
				case 50:
					if (User_1._product2User3 > 0) { // Check for (-1 kg/pc)
						Product2_3.quantity++;
						User_1._product2User3--;
						cout << " Quantity of " << Product2_3.getName() << " - " << User_1._product2User3 << endl;
						cout << "    Successfully decreased \n";
			...
			for (int j = 0; j < 1000; j++) {
				...
				case 49:
					if (Product3_1.getQuantity() > 0) { // checking for storage and user needs
						Product3_1.quantity--;
						User_1._product3User1++;
						cout << " Quantity of " << Product3_1.getName() << " - " << User_1._product3User1 << endl;
						cout << "     Successfully added \n";
						Sleep(0700); Sleep(0700);
					}
					else {
					...
					break;
				case 50:
					if (User_1._product3User1 > 0) { // Check for (-1 kg/pc)
						Product3_1.quantity++;
						User_1._product3User1--;
						cout << " Quantity of " << Product3_1.getName() << " - " << User_1._product3User1 << endl;
						cout << "     Successfully decreased \n";
			...
			for (int j = 0; j < 1000; j++) {
				...
				case 49:
					if (Product3_2.getQuantity() > 0) { // checking for storage and user needs
						Product3_2.quantity--;
						User_1._product3User2++;
						cout << " Quantity of " << Product3_2.getName() << " - " << User_1._product3User2 << endl;
						cout << "     Successfully added \n";
						Sleep(0700); Sleep(0700);
					}
					else {
					...
					break;
				case 50:
					if (User_1._product3User2 > 0) { // Check for (-1 kg/pc)
						Product3_2.quantity++;
						User_1._product3User2--;
						cout << " Quantity of " << Product3_2.getName() << " - " << User_1._product3User2 << endl;
						cout << "     Successfully decreased \n";
			...
			for (int j = 0; j < 1000; j++) {
				...
				case 49:
					if (Product3_3.getQuantity() > 0) { // checking for storage and user needs
						Product3_3.quantity--;
						User_1._product3User3++;
						cout << " Quantity of " << Product3_3.getName() << " - " << User_1._product3User3 << endl;
						cout << "     Successfully added \n";
						Sleep(0700); Sleep(0700);
					}
					else {
					...
					break;
				case 50:
					if (User_1._product3User3 > 0) { // Check for (-1 kg/pc)
						Product3_3.quantity++;
						User_1._product3User3--;
						cout << " Quantity of " << Product3_3.getName() << " - " << User_1._product3User3 << endl;
						cout << "     Successfully decreased \n";
...
void F_Cart_Check() {
	...
	// Check
	for (int i = 1; i <= 1; i++) {
		if (User_1._product1User1 > 0) {
			cout << "\n\t\t\t  " << i << ". " << Product1_1.getName() << " --- " << User_1._product1User1 << " --- Price: " << User_1._product1User1 * Product1_1.getPrice();
			i++;
			Overall_Sum += User_1._product1User1 * Product1_1.getPrice();
		}

		if (User_1._product1User2 > 0) {
			cout << "\n\t\t\t  " << i << ". " << Product1_2.getName() <<" --- " << User_1._product1User2 << " --- Price: " << User_1._product1User2 * Product1_2.getPrice();
			i++;
			Overall_Sum += User_1._product1User2 * Product1_2.getPrice();
		}

		if (User_1._product1User3 > 0) {
			cout << "\n\t\t\t  " << i << ". " << Product1_3.getName() <<" --- " << User_1._product1User3 << " --- Price: " << User_1._product1User3 * Product1_3.getPrice();
			i++;
			Overall_Sum += User_1._product1User3 * Product1_3.getPrice();
		}

		if (User_1._product2User1 > 0) {
			cout << "\n\t\t\t  " << i << ". " << Product2_1.getName() <<" --- " << User_1._product2User1 << " --- Price: " << User_1._product2User1 * Product2_1.getPrice();
			i++;
			Overall_Sum += User_1._product2User1 * Product2_1.getPrice();
		}
		if (User_1._product2User2 > 0) {
			cout << "\n\t\t\t  " << i << ". " << Product2_2.getName() <<" --- " << User_1._product2User2 << " --- Price: " << User_1._product2User2 * Product2_2.getPrice();
			i++;
			Overall_Sum += User_1._product2User2 * Product2_2.getPrice();
		}
		if (User_1._product2User3 > 0) {
			cout << "\n\t\t\t  " << i << ". " << Product2_3.getName() << " --- " << User_1._product2User3 << " --- Price: " << User_1._product2User3 * Product2_3.getPrice();
			i++;
			Overall_Sum += User_1._product2User3 * Product2_3.getPrice();
		}
		if (User_1._product3User1 > 0) {
			cout << "\n\t\t\t  " << i << ". " << Product3_1.getName() << " --- " << User_1._product3User1 << " --- Price: " << User_1._product3User1 * Product3_1.getPrice();
			i++;
			Overall_Sum += User_1._product3User1 * Product3_1.getPrice();
		}
		if (User_1._product3User2 > 0) {
			cout << "\n\t\t\t  " << i << ". " << Product3_2.getName() << " --- " << User_1._product3User2 << " --- Price: " << User_1._product3User2 * Product3_2.getPrice();
			i++;
			Overall_Sum += User_1._product3User2 * Product3_2.getPrice();
		}
		if (User_1._product3User3 > 0) {
			cout << "\n\t\t\t  " << i << ". " << Product3_3.getName()<< " --- " << User_1._product3User3 << " --- Price: " << User_1._product3User3 * Product3_3.getPrice();
			i++;
			Overall_Sum += User_1._product3User3 * Product3_3.getPrice();
		}
		...
		if (i > 1) { // Menu for buying or back 
			...
			case 49: { //buy
				...
				case 49: {
					...
					Overall_Sum = 0;
					// Storage
					User_1._product1User1 = 0; User_1._product1User3 = 0; User_1._product1User2 = 0;
					User_1._product2User1 = 0; User_1._product2User2 = 0; User_1._product2User3 = 0;
					User_1._product3User1 = 0; User_1._product3User2 = 0; User_1._product3User3 = 0;
					F_User_Main_Menu();
				}
					   break;
...
void F_Owner_Products_Stotage() {
	for (int i = 0; i < 1000; i++) {
		...
		case 'i' || 'I':  // User info   
			...
			cout << "\t\t      User Name  : " << memoryName << endl;
			cout << "\t\t      Telephone  : " << memoryParol << endl;
			cout << "\t\t      Login      : " << memoryLogin << endl;
			cout << "\t\t      Password   : " << memoryParol << endl << endl << endl;
			system("pause");
		    break;
